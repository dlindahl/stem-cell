...
function addMiddleware (devServer) {
  ...
  devServer.use(
    historyApiFallback({
       ...
       * We use a heuristic: if request `accept`s text/html, we pick
       ...
       * accept text/html. If this heuristic doesn’t work well for you, don’t
       * use `proxy`.
       */
      // eslint-disable-next-line no-ternary
...
/* eslint-disable
      promise/always-return, promise/no-nesting, promise/catch-or-return
*/
detect(DEFAULT_PORT).then((port) => {
  ...
  if (isInteractive) {
    ...
    // eslint-disable-next-line max-len, no-ternary
